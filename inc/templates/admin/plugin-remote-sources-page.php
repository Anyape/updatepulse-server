					...
					<td>
						...
						<p class="description">
							...
							printf(
								...
								esc_html__( 'In the case of Github and Gitlab, a Personal Access Token (PAT); in the case of Bitbucket, the Bitbucket account email and an API token with scopes formatted like %s.', 'updatepulse-server' ),
