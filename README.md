...
Package updates may be either uploaded directly, or hosted in a Version Control System, public or private, with the latest version of packages stored either locally or in the Cloud. It supports Bitbucket, Github, Gitlab, Gitea, and self-hosted installations of Gitlab or Gitea for package updates; S3 compatible service providers are supported for package storage.
...
Self-hosted VCS               | checkbox  | Check this only if the Version Control System is a self-hosted instance of Gitlab or Gitea.
